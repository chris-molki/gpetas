...
class setup_sampler():
    def __init__(self, data_obj, utm_yes=None, spatial_offspring='R', theta_start_Kcpadgq=None,
                 ...
                 mu_nu0=None, X_grid=None, outdir=None, prior_theta_dist=None, prior_static_bg=None, prior_theta_params=None,
        ...
        :param outdir:
        :type outdir:
        :param prior_static_bg:
        :type prior_static_bg:
        ...
        # background sampler
        self.prior_static_bg = prior_static_bg
